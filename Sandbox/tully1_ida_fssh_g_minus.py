...
import libra_py.dynamics.tsh.recipes.ida_fssh_g_minus as ida_fssh_g_minus
...
def compute_model(q, params, full_id):
    return Tully.Tully1(q, params, full_id)

model_params = { "model":1, "model0":1, "nstates":2, "A": 0.010, "B": 1.600, "C": 0.005, "D": 1.000}
...
ida_fssh_g_minus.load(dyn_params)
